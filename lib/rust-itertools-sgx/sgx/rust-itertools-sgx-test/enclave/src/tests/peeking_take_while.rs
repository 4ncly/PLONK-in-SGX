...
//#[test]
pub fn peeking_take_while_peekable() {
...
//#[test]
pub fn peeking_take_while_put_back() {
...
//#[test]
pub fn peeking_take_while_put_back_n() {
...
//#[test]
pub fn peeking_take_while_slice_iter() {
    let v = [1, 2, 3, 4, 5, 6];
    let mut r = v.iter();
    r.peeking_take_while(|x| **x <= 3).count();
    assert_eq!(r.next(), Some(&4));
...
//#[test]
pub fn peeking_take_while_slice_iter_rev() {
    let v = [1, 2, 3, 4, 5, 6];
